...
When accounting for potential correlation between topics,  @fig-ctm-coherence-sentences (for sentence-tokenized speeches) and @fig-ctm-coherence-words (for word-tokenized speeches) indicate that the optimal number of topics for the BoW-related corpus is three and two, respectively. 
