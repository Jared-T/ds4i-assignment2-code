...
::: {#fig-LSA-coherence layout-ncol=2}

![Words](lsa_plots/words_coherence_plots){#fig-words-coherence}

![Sentences](lsa_plots/sentences_coherence_plots.png){#fig-sentences-coherence}

Coherence plots for LSA 
:::


::: {#fig-LSA-words-BoW-topics layout-ncol=2}

![Topic 1](lsa_plots/words_bow_topic_1.png){#fig-words-bow-topic1}

![Topic 2](lsa_plots/words_bow_topic_2.png){#fig-words-bow-topic2}

![Topic 3](lsa_plots/words_bow_topic_3.png){#fig-words-bow-topic3}

![Topic 4](lsa_plots/words_bow_topic_4.png){#fig-words-bow-topic4}

Topic plots for LSA - BoW
:::


::: {#fig-LSA-sentences-BoW-topics layout-ncol=2}

![Topic 1](lsa_plots/sentences_bow_topic_1.png){#fig-words-bow-topic1}
...
::: {#fig-LSA-tfidf-topics layout-ncol=2}
...
for k in range(ctm.k):
    plot_top_words_for_topic(ctm, 'speeches', k)
...
for k in range(author_topic_model.num_topics):
    plot_top_words_for_author_topic_model(author_topic_model, "speeches",k)
