...
format: html
author: "Jared Tavares (TVRJAR001) and Heiletjé van Zyl (VZYHEI003)"
---
...
bow_matrix_words = vectorizer.fit_transform(sona_speeches_clean['speech'])
...
def compute_coherence_values(dictionary, doc_term_matrix, doc_clean, stop, start=2, step=3):
    ...
    for num_topics in range(start, stop, step):
        # Generate LSA model
        model = LsiModel(tfidf_matrix_words, num_topics=num_topics, id2word=dictionary)  # train model
...
# # LSA Model
# document_list = sona_speeches_clean['speech'].values
# titles = sona_speeches_clean['president'].values
# start,stop,step=2,3,1

# # Convert to Gensim format
# corpus = matutils.Sparse2Corpus(tfidf_matrix_words, documents_columns=False)
