...
When accounting for potential correlation between topics,  @fig-ctm-coherence-sentences (for sentence-tokenized speeches) and @Cfig-ctm-coherence-words (for word-tokenized speeches) indicate that the optimal number of topics for the BoW-related corpus is three and two, respectively. 
...
![Sentences: Topic 1 ~ social cohesion](atm_plots/sentences_1.png){#fig-atm-sentences-topic1}

![Words: Topic  1 ~ diplomatic strategy](atm_plots/words_1.png){#fig-atm-words-topic1}

![Sentences: Topic 2 ~ prospective plans](atm_plots/sentences_2.png){#fig-atm-sentences-topic2}

![Words: Topic 2 ~ general strategic vision](atm_plots/words_2.png){#fig-atm-words-topic2}

![Sentences: Topic 3 ~ esteem within governmental structures](atm_plots/sentences_3.png){#fig-atm-sentences-topic3}
...
topic_labels_words = ['Diplomatic strategy', 'General strategic vision']
topic_labels_sents = ['Social cohesion', 'Prospective plans', 'Esteem within governmental structures']
