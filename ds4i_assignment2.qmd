...
for n_topics in topic_numbers:
    ...
    tfidf_coherence = calculate_umass_coherence(tfidf_result, corpus, tf_idf=True)
    tfidf_coherence_sent = calculate_umass_coherence(tfidf_result_sent, corpus_sent, tf_idf=True)

    bow_coherence = calculate_umass_coherence(bow_result, corpus)
    bow_coherence_sent = calculate_umass_coherence(bow_result_sent, corpus_sent)
    
    # Add the coherence value to the list
    tfidf_coherence_values.append(tfidf_coherence)
    tfidf_coherence_values_sent.append(tfidf_coherence_sent)
    bow_coherence_values.append(bow_coherence)
    bow_coherence_values_sent.append(bow_coherence_sent)
...
# Plot the speech coherence values
plt.figure(figsize=(10, 6))
...
# Plot the sentence coherence values
plt.figure(figsize=(10, 6))
...
def plot_top_words_for_topic(word_given_topic, topic_num, top_n=10):
    ...
    plt.savefig(f'plsa_plots/Top {top_n} Words for Topic {topic_num + 1}.png', bbox_inches='tight')
    plt.close()
