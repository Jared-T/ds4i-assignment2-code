...
![](MacroMicroScheme.png){fig-alt="Schematic representation of sentiment analysis and topic modelling investigated within at different scales within differnt levels."}
...
![](LSA.pdf){fig-alt="Schematic representation of LSA."}
...
```{=html}
<iframe src="pLSA.pdf" width="100%" height="500px">
</iframe>
```


<!-- ![Caption for your PDF figure](/Users/heiletjevanzyl/Desktop/DSFI/STA5073Z Assignment 2/ds4i-assignment2-code/pLSA.pdf)


<embed src="pLSA.pdf" type="application/pdf"> -->
